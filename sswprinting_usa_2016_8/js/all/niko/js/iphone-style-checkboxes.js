...
(function() {
  ...
  iOSCheckbox = (function() {
    function iOSCheckbox(elem, options) {
      ...
      this.elem = $j(elem);
      opts = $j.extend({}, iOSCheckbox.defaults, options);
      for (key in opts) {
        value = opts[key];
        this[key] = value;
      }
    ...
    iOSCheckbox.prototype.wrapCheckboxWithDivs = function() {
      ...
      return this.handle = $j("<div class='" + this.handleClass + "'>\n  <div class='" + this.handleRightClass + "'>\n    <div class='" + this.handleCenterClass + "' />\n  </div>\n</div>").appendTo(this.container);
    };

    iOSCheckbox.prototype.disableTextSelection = function() {
      if ($j.browser.msie) {
        return $j([this.handle, this.offLabel, this.onLabel, this.container]).attr("unselectable", "on");
      }
    };
    ...
    iOSCheckbox.prototype.attachEvents = function() {
      ...
      localMouseUp = function(event) {
        ...
        $j(document).unbind('mousemove touchmove', localMouseMove);
        return $j(document).unbind('mouseup touchend', localMouseUp);
      };
      ...
      return this.container.bind('mousedown touchstart', function(event) {
        ...
        $j(document).bind('mousemove touchmove', localMouseMove);
        return $j(document).bind('mouseup touchend', localMouseUp);
      });
    };
...
//      return false;
  ...
  $j.iphoneStyle = this.iOSCheckbox = iOSCheckbox;

  $j.fn.iphoneStyle = function() {
    ...
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      checkbox = _ref2[_i];
      existingControl = $j(checkbox).data(dataName);
  ...
  $j.fn.iOSCheckbox = function(options) {
    var opts;

    if (options == null) {
      options = {};
    }
    opts = $j.extend({}, options, {
      resizeHandle: false,
