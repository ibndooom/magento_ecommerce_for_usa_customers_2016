<?php
      ...
      //    $response->addHangup(array('schedule'=>'20','reason'=>'busy'));
            $g = $response->addDial(array('timeout'=>'20','dialMusic' => 'http://dev.sswprinting.com/plivo/holdmusic.php','callerName' => 'Customer Service'));
            $g->addUser('sip:ssw150818084453@phone.plivo.com');
            $g->addUser('sip:ssw150922215851@phone.plivo.com');
            $response->addPlay($clip);
            ...
            $response->addRecord(array('redirect' => 'false', 'recordSession' => 'true', 'fileFormat' => 'wav', 'maxLength' => '3600', 'playBeep' => 'false'));
            $g = $response->addDial(array('timeout'=>'20','dialMusic' => 'http://dev.sswprinting.com/plivo/holdmusic.php','callerName' => 'Extension [402]'));
            $g->addUser('sip:ssw150818084453@phone.plivo.com');
            $g->addUser('sip:ssw150922215851@phone.plivo.com');
